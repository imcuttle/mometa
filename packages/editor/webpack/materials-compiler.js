      ...
      childCompiler.runAsChild((err, entries, childCompilation) => {
        ...
        if (entries) {
          compilation.hooks.processAssets.tap(
            ...
            (assets) => {
              console.log('childCompilation.assets', childCompilation.assets)
              // Adding new asset to the compilation, so it would be automatically
              // generated by the webpack in the output directory.
              for (const [k, v] of Object.entries(childCompilation.assets)) {
                compilation.emitAsset(k, v)
              }
            }
          )

          console.log('childCompilation.assets inner', childCompilation.assets)
