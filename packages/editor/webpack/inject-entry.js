 ...
 */
function injectEntry(originalEntry, additionalEntries) {
      ...
      (acc, [curKey, curEntry]) => ({
        ...
        [curKey]:
          typeof curEntry === 'object' && curEntry.import
            ? {
                ...curEntry,
                import: injectEntry(curEntry.import, additionalEntries)
              }
            : injectEntry(curEntry, additionalEntries)
      }),
      {}
    )
  }
  ...
  if (typeof originalEntry === 'function') {
    return (...args) =>
      Promise.resolve(originalEntry(...args)).then((resolvedEntry) => injectEntry(resolvedEntry, additionalEntries))
  }

  throw EntryParseError
}

module.exports = injectEntry
