...
const { getIdentitySourceMap, getModuleSystem, getRefreshModuleRuntime, normalizeOptions } = require('./utils')
const schema = require('./options.json')

const RefreshRuntimePath = require.resolve('react-refresh/runtime.js').replace(/\\/g, '/').replace(/'/g, "\\'")
