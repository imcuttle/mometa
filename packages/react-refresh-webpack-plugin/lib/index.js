...
class ReactRefreshPlugin {
  ...
  apply(compiler) {
    ...
    if (EntryPlugin) {
      ...
      compiler.hooks.make.tap({ name: this.constructor.name, stage: Number.POSITIVE_INFINITY }, (compilation) => {
    ...
    const definedModules = {
      ...
      __react_refresh_library__: JSON.stringify(
        Template.toIdentifier(
          this.options.library || compiler.options.output.uniqueName || compiler.options.output.library
        )
      )
    }
          ...
          compilation.mainTemplate.hooks.require.tap(
            ...
            (source, chunk, hash) => {
              ...
              return Template.asString([
                ...
                '',
                outputOptions.strictModuleExceptionHandling ? Template.indent(moduleInterceptor) : moduleInterceptor,
                '',
